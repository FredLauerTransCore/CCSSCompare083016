...
BEGIN
  ...
  OPEN C1;  
  DBMS_OUTPUT.PUT_LINE('OPEN '||LOAD_TAB||' ETL at: '||to_char(SYSDATE,'MON-DD-YYYY HH:MM:SS'));

  LOOP
  DBMS_OUTPUT.PUT_LINE('LOOP '||LOAD_TAB||' ETL at: '||to_char(SYSDATE,'MON-DD-YYYY HH:MM:SS'));
