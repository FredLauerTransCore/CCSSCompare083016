...
CURSOR C1 IS SELECT 
    ...
    ,f(PA_ACCT_FLAGS.FEIN_NUMBER) FEIN_NUMBER 
    ,f(PA_ACCT_FLAGS.CAST_ACCOUNT_FLAG) CAST_ACCOUNT_FLAG
    ,f(PA_ACCT_TAX_EXEMPTION.TAX_EXEMPTION_ID) TAX_EXEMPTION_ID 
    ,f(PA_ACCT_TAX_EXEMPTION.EXPIRATION_DATE) EXPIRATION_DATE 
