...
CURSOR C1 IS SELECT 
    ...
    ,nvl(pd.PRODUCT_PUR_PRODUCT_CODE,'R') TRAN_TYPE
--    ,(select PROD_ABBRV from PA_PUR_PRODUCT where PUR_PRODUCT_CODE = pd.PRODUCT_PUR_PRODUCT_CODE) TRAN_TYPE    ?
    ,nvl(pp.PUR_PAY_AMT,0) AMOUNT
    ,nvl(pd.PRODUCT_PUR_PRODUCT_CODE,'N') REVERSED  -- PA_PURCHASE_DETAIL.PRODUCT_PUR_PRODUCT_CODE 
