...
CURSOR C1 IS SELECT 
    ...
    ,VEH_LIC_TYPE PLATE_TYPE    -- Prefix and Suffix for the Country and State.  
                                -- Discussion on how FL prefix and suffixes will be handled is an outstanding action item.
...
--    ,SUBSCRIPTION_END_DATE EFFECTIVE_END_DATE
    ...
    ,VEH_COLOR COLOUR
    ,ST_REG_STOP.REG_STOP_SENT_ON REG_STOP_START_DATE  -- ST_REG_STOP
    ,ST_REG_STOP.REG_STOP_REMOVAL_SENT_ON REG_STOP_END_DATE -- ST_REG_STOP
